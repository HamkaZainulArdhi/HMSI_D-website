/**
 * Classes for the Circular Gallery component
 */
...
/**
 * Title class - Renders text below the image
 */
export class Title {
  gl: Renderer["gl"];
  plane: Mesh;
...
/**
 * Media class - Handles individual gallery items
 */
export class Media {
  extra: number = 0;
  geometry: Plane;
...
/**
 * App class - Main controller for the gallery
 */
export class App {
  ...
  createMedias(
    ...
    const galleryItems = items && items.length ? items : DEFAULT_GALLERY_ITEMS;
