...
{ src: "/images/heroimage/2.png", alt: "Image 1", className: "absolute top-40 left-2 w-[80px] h-[100px] sm:top-30 sm:left-8 sm:w-[260px] sm:h-[230px] z-20", strength: 0.02 },
...
{ src: "/images/heroimage/6.png", alt: "Image 3", className: "absolute top-60 left-1/2 w-[110px] h-[90px] -translate-x-1/2 -translate-y-1/2 sm:top-72 sm:left-[58%] sm:w-[290px] sm:h-[180px] z-30", strength: 0.03 },
...
{ src: "/images/heroimage/4.png", alt: "Image 5", className: "absolute bottom-50 right-2 w-[120px] h-[80px] sm:bottom-40 sm:right-0 sm:w-[290px] sm:h-[170px] z-20", strength: 0.03 },
