...
const sampleImages = [
  '/images/bootcamp/folder-1.jpg',
  '/images/bootcamp/folder-2.jpg',
  '/images/bootcamp/folder-3.jpg'
];
...
const Folder: React.FC<FolderProps> = ({
  color = "#00d8ff",
  size = 1,
  images = sampleImages, // Use sampleImages as default
  className = "",
}) => {
  const maxItems = 3;
  const papers = images.slice(0, maxItems);
  while (papers.length < maxItems) {
    papers.push(''); // Push empty string for missing images
  }
