...
export default function ProfileSectionAbout() {
  ...
  return (
    <div className="bg-whitecus mt-15 flex flex-col items-center justify-center px-4 py-12 transition-colors duration-500 sm:px-16 lg:min-h-screen dark:bg-black">
      <h1
      ...
      <div className="flex max-w-7xl items-start text-sm">
        ...
        <p className="ml-auto max-w-5xl text-justify text-slate-600 lg:text-[18px] dark:text-slate-300">
          ...
          inceptos himenaeos. Curabitur tempus urna at turpis kita harus kompak
